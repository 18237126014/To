...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/nonfarm/sj_nonfarm.css')}}">
...
<div class="footer">
    <div class="footer-content">
        <img src="http://img.zengwf.com/images/nonfarm/5yuan.png" alt="" style="width:47rem;">
    </div>
</div>
<div class="copyright">
...
<!--表单-->
<div class="layui-layer layui-layer-page layer-form layer-anim" id="layui-layer3" type="page" showtime="0"time="3" contype="object" style="display: none;left:10rem;top:27rem;">
