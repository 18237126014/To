...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/htcj/sj_htcj.css')}}">
        ...
        <div class="bot_icon ">
            ...
            <ul class="downs clearfix">
                ...
                <li style="border-right: 0;">
                    <a href="javascript:void(0)">
                        <img src="http://img.zengwf.com/images/htcj/iphone.png" alt="" style="width:3rem">
                        <p>手机版下载</p>
                    </a>
                </li>
            </ul>
        </div>
        <div class="bot_icon" style="margin-top: 1rem">
            <h2>金闻快讯</h2>
...
<!--表单-->
<div class="layui-layer layui-layer-page layer-form layer-anim" id="layui-layer3" type="page" showtime="0"time="3" contype="object" style="display: none;left: 12rem;top: 19rem;">
