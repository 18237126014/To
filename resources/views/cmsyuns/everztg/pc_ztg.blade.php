...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/everztg/pc_everztg.css')}}">
    <link rel="stylesheet" href="{{url('css/everztg/layer.css')}}">
    <script src="{{url('js/jquery.js')}}"></script>
    <script src="{{url('js/everztg/layer.js')}}"></script>
    <script src="{{url('js/everztg/everztg.js')}}"></script>
</head>
<body>
    <div class="top">
        <div class="top_1"></div>
        <div class="top_2">
            <div class="ewm">
                <img src="http://img.zengwf.com/images/wxtg/kenan198808.jpg">
            </div>
            <div class="ewm_tx wxnumber">kenan198808</div>
        </div>
        <div class="top_3"></div>
    </div>
    <div class="content">
        <p class=" yii_template" type="text" name="t3">12月历史战绩！这些股，领到的都赚大发了！</p>
