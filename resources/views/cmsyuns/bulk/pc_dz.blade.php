...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/bulk/dz.css')}}">
...
<div class="bg head">
    <div class="wrapper">
        <a href="javascript:void(0)" class="btn1 pc-btn btn-down open" >
            <img src="http://img.zengwf.com/images/bulk/button1.png">
        </a>
        <a href="javascript:void(0)" class="btn2 wap-btn btn-down open" >
            <img src="http://img.zengwf.com/images/bulk/button2.png">
        </a>
    </div>
</div>
<div class="bg content">
    <div class="wrapper clearfix">
        ...
        <div class="dv_middle">
            <img src="http://img.zengwf.com/images/metal/img1.png" alt="" id="slide" width="673" height="547">
        </div>
        <div class="dv_right">
