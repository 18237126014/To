...
<head>
    <meta charset="UTF-8">
    <title>大宗商品交易软件下载</title>
    <link rel="stylesheet" href="{{url('css/bulk/sj_dz.css')}}">
...
<div class="top">
    <div class="top_con">
        <img src="http://img.zengwf.com/images/bulk/title.png" alt="" class="title">
        <img src="http://img.zengwf.com/images/bulk/5title.png" alt="" class="tit5">
        <div class="top_middle clearfix">
            <div class="floatl">
                <img src="http://img.zengwf.com/images/bulk/mac.png" alt="" style="width:29rem">
            </div>
            <div class="floatr">
                <img src="http://img.zengwf.com/images/bulk/threegen.png" alt="" >
            </div>
        </div>
        <ul class="downs clearfix">
            <li><a href="javascript:void(0)"><img src="http://img.zengwf.com/images/bulk/button1.png" alt=""></a></li>
            <li><a href="javascript:void(0)"><img src="http://img.zengwf.com/images/bulk/button2.png" alt=""></a></li>
        </ul>
    </div>
</div>
