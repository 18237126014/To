...
<div class="div-2">
    ...
    <div class="right-2">
        ...
        <h4>超级Level-2</h4>
        <p>
            深度洞悉盘口风云变化，辨识多空双方PK实力<br />
            比一般Level-2快<span>100</span>倍，比普通行情快<span>1000</span>倍
        </p>
        <h4>盘口异动</h4>
        <p>
            第一时间掌握个股异动信息<br />
...
<div class="div-3">
    ...
    <div class="right-3">
        <img src="http://img.zengwf.com/images/dfcf/img2.png" alt="">
    </div>
</div>
<div class="div-4">
    <div class="left-4">
        <img src="http://img.zengwf.com/images/dfcf/img3.png" alt="">
    </div>
    <div class="right-4 right-2">
        <p><span>智能选股</span></p>
        <p>
            紧跟市场热点，稳抓交易机会<br />
            以大数据为基础，密切关注资金流向，分析投资价值，<br />提供智能化选股策略，满足你的各种选股需求
        </p>
    </div>
    <ul class="downs" style="margin-top: -8rem;
    margin-left: 35rem;">
        <li class="sjAPP">
            <div class="fl img_03"></div>
            <div class="fr sj_down" id=" ">
...
<div class="div-5">
    <div class="top-5"></div>
    <div class="left-5 right-2">
        <p><span>指纹与手势快捷登录</span></p>
        <p>
            潇洒一按，登录快如闪电<br />
            小手一划，绘制自己的专属密码<br />
            毫秒级极速登录，不错过每一个<br />
    ...
    <div class="right-5">
        <img src="http://img.zengwf.com/images/dfcf/img4.png" alt="">
    </div>
    <ul class="downs" style="margin-top: -11rem;
    margin-left:7rem;">
        <li class="sjAPP">
            <div class="fl img_03"></div>
            <div class="fr sj_down" id=" ">
...
<div class="big-6">
    <div class="div-6">
        <div class="left-6">
            <img src="http://img.zengwf.com/images/dfcf/img5.png" alt="">
        </div>
        <div class="right-6 right-2">
            <p><span>积分专区</span></p>
            <p>
                花样赚积分，积分送好礼<br />
                好玩又赚钱，奖品统统都到碗里来<br />
        ...
        <ul class="downs" style="margin-top: -14rem;
    margin-left: 28rem;">
            <li class="sjAPP">
                <div class="fl img_03"></div>
                <div class="fr sj_down" id=" ">
...
<div class="big-7">
    <div class="div-7">
        ...
        <div class="right-7">
            <img src="http://img.zengwf.com/images/dfcf/img6.png" alt="">
        </div>
        <ul class="downs" style="margin-top: -10rem;
    margin-left: 6rem;">
            <li class="sjAPP">
                <div class="fl img_03"></div>
                <div class="fr sj_down" id=" ">
...
<div class="big-8">
    <div class="div-8">
        <div class="left-8">
            <img src="http://img.zengwf.com/images/dfcf/img7.png" alt="">
        </div>
        <div class="right-8 right-2">
            <p><span>分时显示双副图指标</span></p>
            <p>
                一个指标不够用？<br />
                分时双副图，多个对比，多份胜算<br />
            </p>
        </div>
        <ul class="downs" style="margin-top: -16rem;
    margin-left: 29rem;">
            <li class="sjAPP">
                <div class="fl img_03"></div>
                <div class="fr sj_down" id=" ">
...
<div class="div-9">
    <div class="left-9 right-2">
        <p><span>分时显示集合竞价</span></p>
        <p>
            助力决策，决胜千里<br />
            先人一步知早盘，快人一步稳赚钱<br />
        </p>
    ...
    <div class="right-9">
        <img src="http://img.zengwf.com/images/dfcf/img8.png" alt="">
    </div>
    <ul class="downs" style="margin-top: -16rem;
    margin-left: 9rem;">
        <li class="sjAPP">
...
<div class="copyright">
    ...
    <p style="font-size: 1.1rem;">&copy; 版权所有：韩城集升商贸有限公司</p>
</div>
{{--写跳转过来的页面--}}
