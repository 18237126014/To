...
<head>
    <meta charset="UTF-8">
    <title>随身行软件下载</title>
    <link rel="stylesheet" href="{{url('css/touzi/touzi.css')}}">
    <link rel="stylesheet" href="{{url('css/touzi/bootstrap.css')}}">
    <link rel="stylesheet" href="{{url('css/xsy/sj_ysy.css')}}">
...
<div class="content">
    <div>
        <img src="http://img.zengwf.com/images/sjssx/top1.gif" alt="" >
    </div>
    <div style="height:15px;"></div>
    <div>
        <img src="http://img.zengwf.com/images/sjssx/ssx_01.png" alt="" width="100%">
    </div>
    <div style="">
        <img src="http://img.zengwf.com/images/sjssx/ssx_02.png" alt="" width="100%" >
    </div>
    <div style="position: relative;;">
        <img src="http://img.zengwf.com/images/sjssx/ssx_03.png" alt="" width="100%">
        <a href="javascript:void(0)" class="btn">下载随身行软件</a>
    </div>

</div>
<div class="footer">
    <h2 style="text-align: center;">投资有风险,入市需谨慎</h2>
    <p style="text-align: center;">&copy; 版权所有：韩城集升商贸有限公司</p>
</div>
{{--写跳转过来的页面--}}
...
<!--表单-->
<div class="layui-layer layui-layer-page layer-form layer-anim" id="layui-layer3" type="page" showtime="0"time="3" contype="object" style="display: none;left:16rem;top:32rem;">
