...
<head>
    ...
    <style>
        *{margin:0;padding:0;}
        ...
        .btn{display: inline-block;background:#e08b21;position:absolute;width:185px;height:50px;top:33px;left:406px;text-align: center;
            line-height: 50px;
            font-weight: 500;color:#fff;border-radius:7px;}
        .copyright{
            width:100%;
...
<div>
    <div class="content">
        <div>
            <img src="http://img.zengwf.com/images/xsy/ysy4.jpg" alt="">
        </div>
        <div style="height:15px;"></div>
        <div>
            <img src="http://img.zengwf.com/images/xsy/ysy1.jpg" alt="">
        </div>
        <div style="margin-top:-5px;">
            <img src="http://img.zengwf.com/images/xsy/ysy2.jpg" alt="">
        </div>
        <div style="position: relative;margin-top:-5px;">
            <img src="http://img.zengwf.com/images/xsy/ysy3.jpg" alt="">
            <a href="javascript:void(0)" class="btn downBtn">立即下载</a>
        </div>
        <div class="copyright" >
            <h2 style="margin-bottom: 0;">投资有风险,入市需谨慎</h2>
            <p style="font-size: 17px;">&copy; 版权所有：韩城集升商贸有限公司</p>
        </div>
    </div>
</div>
{{--写跳转过来的页面--}}
