...
<head>
    <meta charset="UTF-8">
    <title>跟着大神炒黄金</title>
    <link rel="stylesheet" type="text/css" href="{{url('/css/wxtg/pc_wxtg.css')}}">
...
<div class="r_wx" style="display: none;">
    <img src="http://img.zengwf.com/images/wxtg/wxtg3.jpg" alt="">
    <ul>
        <li class="wx_s">扫一扫，即送</li>
        <li>50万模拟金和每日投资攻略</li>
    </ul>
    <p>或搜索微信号<span>yingkun198809</span></p>
</div>
<div id="banner">
    <div class="banner">
        <div class="b_con">
...
<div class="simulation">
    ...
    <div class="s_img">
        <ul>
            ...
            <li>数据与实盘同步，体验最真实的交易环境，开启<span>无风险投资</span>体验。</li>
            <li>全天候<span>名师坐镇</span>，机会提醒；下单建议；专家答疑异动解析，全部免费</li>
            <li>名师互动交易指导，<span>深入挖掘操盘技巧</span>，不错失买卖良机</li>
        </ul>
    </div>
</div>
<div class="layout">
    <h2></h2>
    <div class="layout_img"><img src="http://img.zengwf.com/images/wxtg/img2.png"></div>
    <div class="layout_img1"><img src="http://img.zengwf.com/images/wxtg/zzzz1.png"></div>
</div>
<div class="Record">
...
<div class="tankuang hide">
    ...
    <p class="txt_three" data-weixin-href="" onclick="_czc.push(['_trackEvent', '点击复制8', '关注微信']);"> yingkun198809</p>
</div>
