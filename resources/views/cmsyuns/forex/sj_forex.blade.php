...
<head>
    <meta charset="UTF-8">
    <title>外汇投资终端</title>
    <link rel="stylesheet" href="{{url('css/forex/sj_forex.css')}}">
...
<body>
        ...
        <div class="content clearfix">
            <div class="conl floatl">
                ...
                <ul class="downs clearfix">
                    <li class="floatl"><a href="javascript:void(0)"><img src="http://img.zengwf.com/images/forex/Wdown.png" alt=""></a></li>
                    <li class="floatl"><a href="javascript:void(0)"><img src="http://img.zengwf.com/images/forex/Mdown.png" alt=""></a></li>
                </ul>
            </div>
            <div class="conr floatr">
    ...
    <div class="index3">
        <div class="content clearfix" style="padding-top:1rem;">
            <div class="conr floatl" style="padding-top:3rem">
                <img src="http://img.zengwf.com/images/forex/dn3.png" alt="">
            </div>
            <div class="conl floatr">
                <img src="http://img.zengwf.com/images/forex/con3.png" alt="">
                <ul class="downs clearfix">
                    <li class="floatl"><a href="javascript:void(0)"><img src="http://img.zengwf.com/images/forex/Wdown3.png" alt=""></a></li>
                    <li class="floatl"><a href="javascript:void(0)"><img src="http://img.zengwf.com/images/forex/Mdown3.png" alt=""></a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="index5">
        <div class="content clearfix" style="padding-top:1rem;">
            <div class="conl floatl">
                ...
                <ul class="downs clearfix">
                    <li class="floatl"><a href="javascript:void(0)"><img src="http://img.zengwf.com/images/forex/Wdown2.png" alt=""></a></li>
                    <li class="floatl"><a href="javascript:void(0)"><img src="http://img.zengwf.com/images/forex/Mdown2.png" alt=""></a></li>
                </ul>
            </div>
            <div class="conr floatr" style="padding-top:4rem">
                <img src="http://img.zengwf.com/images/forex/dn5.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="index6">
        <div class="content clearfix" style="padding-top:1rem;">
            <div class="conr floatl" style="padding-top:5rem">
                <img src="http://img.zengwf.com/images/forex/dn6.png" alt="">
            </div>
            <div class="conl floatr">
