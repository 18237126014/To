...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/calendar/calendar.css')}}">
...
<body>
    ...
    <div class="footer">
        <div class="footer-content">
            <img src="http://img.zengwf.com/images/calendar/5big.png" alt="" style="margin-top: 2%;width: 80%;">
            <img src="http://img.zengwf.com/images/calendar/5content.png" alt="" style="width: 80%;">
        </div>
    </div>
    <div class="copyright">
